...
void Parameters::init_key_dict(const std::vector<string>& keys){
...
void Parameters::load_parameters(const string& param_path){

    load_param_file(param_path);
...
void Parameters::load_param_file(const string& param_path){
